...
class Home extends Component {
  render() {
    return (
      <div>
        <h2>Huzzah! Welcome to the EOG React Assessment!</h2>
        <h5>I think our industry hires completely wrong and want to change that.
So I created this assessment to help us. The deal:</h5>
        <p>Good day. Nice to meet you. My name is Jesse Wolgamott, and I think the entire software industry hires people incredibly poorly. You've probably been brought in to interview and had to write an algorithm or binary tree, from scratch, on a whiteboard. You don't get your keyboard, your google, your notes, anything -- and you're timed and it's stressful.
